...
```{r saved-xg, out.width = "80%", fig.cap = "Average xG Defended vs. Average xG", fig.align='center', echo = FALSE, fig.pos = "H"}
...
The summary results of the 3 North American matches show that 2Piece and MaJicBear, both of whom were on the winning team ‘LAST MINUTE’, had an average xG that surpassed their actual goal rate. 
